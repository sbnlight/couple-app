...
- 💬 **聊天**:实时收发、图片、emoji、自定义表情包、已读回执、历史记录搜索;弱网容错(断线补拉、失败重试队列、幂等防重复)
- 📒 **记账**:共同账本、多货币、收入/支出、共同/个人、月度汇总与分类占比
- 👫 **我们**:对方当地时间、见面倒数日、纪念日、每日一问、想你打卡、愿望清单、定时开启的留言小纸条
- 🔔 **推送通知**(可选):App 关闭时也能收到新消息提醒(iOS PWA 支持良好)
- 🎨 个性化:四套主题色、字体大小、深浅模式;开场动画
